<section style="min-height: calc(100vh - 83px);" class="light-bg">
    ...
    <div class="container">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_courses" role="tab" data-toggle="tab">Serviços</a></li>
        ...
        <div class="tab-content">
            <div id="tab_courses" class="tab-pane active">
                <div class="container-fluid">
                    ...
                    <a id="btn_add_service" class="btn btn-primary">
                        <i class="fa fa-plus"> 
                        &nbsp;&nbsp;Adicionar Serviços
                        </i>
                    </a>
                    <table id="dt_services" class="table table-stripped table-bordered">
                        <thead>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div clas="modal-body">
                    <form id="form_service" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <input id="service_img" name="service_img" hidden>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div clas="col-lg-10">
                                <input type="number" id="service_duration" name="service_duration" class="form-control" step="0.1"/>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
