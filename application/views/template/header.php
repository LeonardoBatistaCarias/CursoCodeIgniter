...
<html lang="en">
	<head>
		...
		<title>Leo Tech - Serviços TI</title>
		<!-- Bootstrap core CSS -->
		...
		<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="#page-top"><img src="<?php echo base_url(); ?>public/images/logoV2.png" alt="Logo da Empresa"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#service">Serviços</a>
						</li>
						<li>
